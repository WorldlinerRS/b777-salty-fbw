import {B777_FMC} from '../../fmc/B777_FMC';

export class BasicVNAVDirector {
	private _fmc: B777_FMC;
	...
	calculateFpmToNextWaypoint(altitude, targetAltitude, distance, waypoint, targetType) {
		...
		console.log('TARGET WAYPOINT: ' + waypoint.ident);
		console.log('TARGET WAYPOINT: ' + waypoint.ident);
		...
		console.log('MILES PER MINUTE: ' + milesPerMinute);
		console.log('DESCENT RATE: ' + rate);
		return rate;
	}
}
