...
export class TakeOffPhase extends Phase {
    ...
    init() {
        ...
        SimVar.SetSimVarValue('L:B77RS_COLD_AND_DARK_SPAWN', 'Bool', false);
        ...
        this.accelerationAltitudeMslEo = SimVar.GetSimVarValue('L:B77RS_ENG_OUT_ACC_ALT', 'feet');
    }
...
export class DescentPhase extends Phase {
    ...
    shouldActivateNextPhase(_deltaTime) {
        ...
        return !!SimVar.GetSimVarValue('L:B77RS_FM_ENABLE_APPROACH_PHASE', 'Bool');
    }
}
