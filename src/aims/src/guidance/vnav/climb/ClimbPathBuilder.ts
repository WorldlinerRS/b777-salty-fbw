...
export class ClimbPathBuilder {
    static computeClimbPath(
        ...
        const airfieldElevation = SimVar.GetSimVarValue('L:B77RS_DEPARTURE_ELEVATION', 'feet') ?? 0;
        ...
        const commandedN1Toga = SimVar.GetSimVarValue('L:B77RS_AUTOTHRUST_THRUST_LIMIT', 'Percent') ?? 0;
        ...
        const commandedN1Climb = SimVar.GetSimVarValue('L:B77RS_AUTOTHRUST_THRUST_LIMIT', 'Percent') ?? 0;
