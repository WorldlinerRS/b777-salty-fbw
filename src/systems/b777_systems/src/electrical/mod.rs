...
use self::{
    alternating_current::B777AlternatingCurrentElectrical,
    direct_current::B777DirectCurrentElectrical,
...
pub(super) struct B777Electrical {
...
impl B777Electrical {
    pub fn new(context: &mut InitContext) -> B777Electrical {
        B777Electrical {
            galley_is_shed_id: context.get_identifier("ELEC_GALLEY_IS_SHED".to_owned()),
            alternating_current: B777AlternatingCurrentElectrical::new(context),
            direct_current: B777DirectCurrentElectrical::new(context),
    ...
    pub fn update(
        ...
        overhead: &B777ElectricalOverheadPanel,
        emergency_overhead: &B777EmergencyElectricalOverheadPanel,
...
impl SimulationElement for B777Electrical {
...
impl EmergencyElectricalState for B777Electrical {
    fn is_in_emergency_elec(&self) -> bool {
        self.in_emergency_elec()
    }
}
impl EmergencyGeneratorPower for B777Electrical {
    fn generated_power(&self) -> Power {
        self.emergency_gen.generated_power()
    }
}

trait B777DirectCurrentElectricalSystem {
    fn static_inverter(&self) -> &StaticInverter;
}

trait B777AlternatingCurrentElectricalSystem: AlternatingCurrentElectricalSystem {
...
pub(super) struct B777ElectricalOverheadPanel {
...
impl B777ElectricalOverheadPanel {
    pub fn new(context: &mut InitContext) -> B777ElectricalOverheadPanel {
        B777ElectricalOverheadPanel {
            batteries: [
...
impl EngineGeneratorPushButtons for B777ElectricalOverheadPanel {
...
impl BatteryPushButtons for B777ElectricalOverheadPanel {
    fn bat_is_auto(&self, number: usize) -> bool {
        self.batteries[number - 1].is_auto()
    }
}
impl SimulationElement for B777ElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct B777EmergencyElectricalOverheadPanel {
...
impl B777EmergencyElectricalOverheadPanel {
...
impl SimulationElement for B777EmergencyElectricalOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl EmergencyElectricalRatPushButton for B777EmergencyElectricalOverheadPanel {
...
mod b777_electrical {
    ...
    #[test]
    fn writes_its_state() {
        let mut test_bed = SimulationTestBed::from(ElementCtorFn(B777Electrical::new));
...
#[cfg(test)]
mod b777_electrical_circuit_tests {
    use super::{alternating_current::B777AcEssFeedContactors, *};
    use rstest::rstest;
    ...
    /// # Source
    /// B777 manual electrical distribution table
    #[test]
    ...
    /// # Source
    /// Derived from B777 manual electrical distribution table
    ...
    fn test_bed_with() -> B777ElectricalTestBed {
        test_bed()
    }

    fn test_bed() -> B777ElectricalTestBed {
        B777ElectricalTestBed::new()
    }
    ...
    struct B777ElectricalTestAircraft {
    ...
    impl B777ElectricalTestAircraft {
        fn new(context: &mut InitContext) -> Self {
            Self {
                engines: [TestEngine::new(), TestEngine::new()],
                ext_pwr: ExternalPowerSource::new(context),
                elec: B777Electrical::new(context),
                overhead: B777ElectricalOverheadPanel::new(context),
                emergency_overhead: B777EmergencyElectricalOverheadPanel::new(context),
    ...
    impl Aircraft for B777ElectricalTestAircraft {
    ...
    impl SimulationElement for B777ElectricalTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
            self.ext_pwr.accept(visitor);
    ...
    struct B777ElectricalTestBed {
        test_bed: SimulationTestBed<B777ElectricalTestAircraft>,
    }
    impl B777ElectricalTestBed {
        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(B777ElectricalTestAircraft::new),
            }
        }
        ...
        fn both_ac_ess_feed_contactors_open(&mut self) -> bool {
            !ReadByName::<B777ElectricalTestBed, bool>::read_by_name(
                self,
        ...
        fn run_waiting_for_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(B777AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS)
        }

        fn run_waiting_until_just_before_ac_ess_feed_transition(self) -> Self {
            self.run_waiting_for(
                B777AcEssFeedContactors::AC_ESS_FEED_TO_AC_BUS_2_DELAY_IN_SECONDS
                    - Duration::from_millis(1),
            )
        }
    }
    impl TestBed for B777ElectricalTestBed {
        type Aircraft = B777ElectricalTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<B777ElectricalTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<B777ElectricalTestAircraft> {
            &mut self.test_bed
        }
    }
}
