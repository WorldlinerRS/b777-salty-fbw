...
pub(super) struct B777DirectCurrentElectrical {
...
impl B777DirectCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        B777DirectCurrentElectrical {
    ...
    pub fn update(
        ...
        ac_state: &impl B777AlternatingCurrentElectricalSystem,
...
impl B777DirectCurrentElectricalSystem for B777DirectCurrentElectrical {
    fn static_inverter(&self) -> &StaticInverter {
        &self.static_inverter
    }
}
impl SimulationElement for B777DirectCurrentElectrical {
