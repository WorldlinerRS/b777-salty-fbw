use super::{
    B777AlternatingCurrentElectricalSystem, B777DirectCurrentElectricalSystem,
    B777ElectricalOverheadPanel, B777EmergencyElectricalOverheadPanel,
};
...
pub(super) struct B777AlternatingCurrentElectrical {
    main_power_sources: B777MainPowerSources,
    ac_ess_feed_contactors: B777AcEssFeedContactors,
...
impl B777AlternatingCurrentElectrical {
    pub fn new(context: &mut InitContext) -> Self {
        B777AlternatingCurrentElectrical {
            main_power_sources: B777MainPowerSources::new(context),
            ac_ess_feed_contactors: B777AcEssFeedContactors::new(context),
    ...
    pub fn update_after_direct_current(
        ...
        electricity: &mut Electricity,
        emergency_generator: &EmergencyGenerator,
        dc_state: &impl B777DirectCurrentElectricalSystem,
    ) {
...
impl B777AlternatingCurrentElectricalSystem for B777AlternatingCurrentElectrical {
...
impl AlternatingCurrentElectricalSystem for B777AlternatingCurrentElectrical {
...
impl SimulationElement for B777AlternatingCurrentElectrical {
...
impl B777MainPowerSources {
    fn new(context: &mut InitContext) -> Self {
        B777MainPowerSources {
...
impl SimulationElement for B777MainPowerSources {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
pub(super) struct B777AcEssFeedContactors {
...
impl SimulationElement for B777AcEssFeedContactors {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
