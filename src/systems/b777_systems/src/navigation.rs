...
pub struct B777RadioAltimeters {
    radio_altimeter_1: B777RadioAltimeter,
    radio_altimeter_2: B777RadioAltimeter,
}

impl B777RadioAltimeters {
    pub fn new(context: &mut InitContext) -> Self {
        Self {
            radio_altimeter_1: B777RadioAltimeter::new(
                context,
                1,
            ...
            radio_altimeter_2: B777RadioAltimeter::new(
                context,
                2,
...
impl SimulationElement for B777RadioAltimeters {
...
impl SimulationElement for B777RadioAltimeter {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
