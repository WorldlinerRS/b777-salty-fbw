...
mod tests {
    ...
    impl Aircraft for B777FlapsTestAircraft {
    ...
    impl SimulationElement for B777FlapsTestAircraft {
        fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    struct B777FlapsTestBed {
        test_bed: SimulationTestBed<B777FlapsTestAircraft>,
    }

    impl B777FlapsTestBed {
        const HYD_TIME_STEP_MILLIS: u64 = 33;

        fn new() -> Self {
            Self {
                test_bed: SimulationTestBed::new(B777FlapsTestAircraft::new),
            }
        }
    ...
    impl TestBed for B777FlapsTestBed {
        type Aircraft = B777FlapsTestAircraft;

        fn test_bed(&self) -> &SimulationTestBed<B777FlapsTestAircraft> {
            &self.test_bed
        }

        fn test_bed_mut(&mut self) -> &mut SimulationTestBed<B777FlapsTestAircraft> {
            &mut self.test_bed
        }
    }

    fn test_bed() -> B777FlapsTestBed {
        B777FlapsTestBed::new()
    }

    fn test_bed_with() -> B777FlapsTestBed {
        test_bed()
    }
