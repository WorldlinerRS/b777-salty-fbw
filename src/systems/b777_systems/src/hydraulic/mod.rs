...
struct B777HydraulicReservoirFactory {}
impl B777HydraulicReservoirFactory {
...
pub struct B777HydraulicCircuitFactory {}
impl B777HydraulicCircuitFactory {
    ...
    pub fn new_green_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = B777HydraulicReservoirFactory::new_green_reservoir(context);
    ...
    pub fn new_blue_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = B777HydraulicReservoirFactory::new_blue_reservoir(context);
        HydraulicCircuit::new(
            context,
            HydraulicColor::Blue,
            1,
    ...
    pub fn new_yellow_circuit(context: &mut InitContext) -> HydraulicCircuit {
        let reservoir = B777HydraulicReservoirFactory::new_yellow_reservoir(context);
        HydraulicCircuit::new(
            context,
            HydraulicColor::Yellow,
            1,
...
struct B777CargoDoorFactory {}
impl B777CargoDoorFactory {
    ...
    /// Builds a cargo door body for B777 Neo
    fn b777_cargo_door_body(is_locked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn b777_cargo_door_assembly() -> HydraulicLinearActuatorAssembly<1> {
        let cargo_door_body = Self::b777_cargo_door_body(true);
        let cargo_door_actuator = Self::b777_cargo_door_actuator(&cargo_door_body);
        HydraulicLinearActuatorAssembly::new([cargo_door_actuator], cargo_door_body)
    }

    fn new_b777_cargo_door(context: &mut InitContext, id: &str) -> CargoDoor {
        let assembly = Self::b777_cargo_door_assembly();
        CargoDoor::new(
            context,
            id,
            assembly,
            Self::new_b777_cargo_door_aero_model(),
        )
    }

    fn new_b777_cargo_door_aero_model() -> AerodynamicModel {
        let body = Self::b777_cargo_door_body(false);
...
struct B777AileronFactory {}
impl B777AileronFactory {
    ...
    fn b777_aileron_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
    ...
    /// Builds an aileron control surface body for B777 Neo
    fn b777_aileron_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// to it
    fn b777_aileron_assembly(init_drooped_down: bool) -> HydraulicLinearActuatorAssembly<2> {
        let aileron_body = Self::b777_aileron_body(init_drooped_down);

        let aileron_actuator_outward = Self::b777_aileron_actuator(&aileron_body);
        let aileron_actuator_inward = Self::b777_aileron_actuator(&aileron_body);
    ...
    fn new_aileron(context: &mut InitContext, id: ActuatorSide) -> AileronAssembly {
        ...
        let assembly = Self::b777_aileron_assembly(init_drooped_down);
        AileronAssembly::new(context, id, assembly, Self::new_b777_aileron_aero_model())
    }

    fn new_b777_aileron_aero_model() -> AerodynamicModel {
        let body = Self::b777_aileron_body(true);
...
struct B777SpoilerFactory {}
impl B777SpoilerFactory {
    ...
    fn b777_spoiler_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
        let actuator_characteristics = LinearActuatorCharacteristics::new(
    ...
    /// Builds a spoiler control surface body for B777 Neo
    fn b777_spoiler_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn b777_spoiler_assembly() -> HydraulicLinearActuatorAssembly<1> {
        let spoiler_body = Self::b777_spoiler_body();

        let spoiler_actuator = Self::b777_spoiler_actuator(&spoiler_body);

        HydraulicLinearActuatorAssembly::new([spoiler_actuator], spoiler_body)
    }

    fn new_b777_spoiler_group(context: &mut InitContext, id: ActuatorSide) -> SpoilerGroup {
        let spoiler_1 = Self::new_b777_spoiler_element(context, id, 1);
        let spoiler_2 = Self::new_b777_spoiler_element(context, id, 2);
        let spoiler_3 = Self::new_b777_spoiler_element(context, id, 3);
        let spoiler_4 = Self::new_b777_spoiler_element(context, id, 4);
        let spoiler_5 = Self::new_b777_spoiler_element(context, id, 5);
    ...
    fn new_b777_spoiler_element(
        context: &mut InitContext,
        id: ActuatorSide,
        id_number: usize,
    ) -> SpoilerElement {
        let assembly = Self::b777_spoiler_assembly();
        SpoilerElement::new(
            context,
            id,
            id_number,
            assembly,
            Self::new_b777_spoiler_aero_model(),
        )
    }

    fn new_b777_spoiler_aero_model() -> AerodynamicModel {
        let body = Self::b777_spoiler_body();
...
struct B777ElevatorFactory {}
impl B777ElevatorFactory {
    ...
    fn b777_elevator_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
        let actuator_characteristics = LinearActuatorCharacteristics::new(
            Self::MAX_DAMPING_CONSTANT_FOR_SLOW_DAMPING / 5.,
            Self::MAX_DAMPING_CONSTANT_FOR_SLOW_DAMPING,
    ...
    /// Builds an aileron control surface body for B777 Neo
    fn b777_elevator_body(init_drooped_down: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn b777_elevator_assembly(init_drooped_down: bool) -> HydraulicLinearActuatorAssembly<2> {
        let elevator_body = Self::b777_elevator_body(init_drooped_down);

        let elevator_actuator_outboard = Self::b777_elevator_actuator(&elevator_body);
        let elevator_actuator_inbord = Self::b777_elevator_actuator(&elevator_body);
    ...
    fn new_elevator(context: &mut InitContext, id: ActuatorSide) -> ElevatorAssembly {
        let init_drooped_down = !context.is_in_flight();
        let assembly = Self::b777_elevator_assembly(init_drooped_down);
        ElevatorAssembly::new(context, id, assembly, Self::new_b777_elevator_aero_model())
    }

    fn new_b777_elevator_aero_model() -> AerodynamicModel {
        let body = Self::b777_elevator_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct B777RudderFactory {}
impl B777RudderFactory {
    ...
    fn b777_rudder_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
        let actuator_characteristics = LinearActuatorCharacteristics::new(
    ...
    /// Builds an aileron control surface body for B777 Neo
    fn b777_rudder_body(init_at_center: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    /// Builds an aileron assembly consisting of the aileron physical rigid body and two hydraulic actuators connected
    /// to it
    fn b777_rudder_assembly(init_at_center: bool) -> HydraulicLinearActuatorAssembly<3> {
        let rudder_body = Self::b777_rudder_body(init_at_center);

        let rudder_actuator_green = Self::b777_rudder_actuator(&rudder_body);
        let rudder_actuator_blue = Self::b777_rudder_actuator(&rudder_body);
        let rudder_actuator_yellow = Self::b777_rudder_actuator(&rudder_body);
    ...
    fn new_rudder(context: &mut InitContext) -> RudderAssembly {
        ...
        let assembly = Self::b777_rudder_assembly(init_at_center);
        RudderAssembly::new(context, assembly, Self::new_b777_rudder_aero_model())
    }

    fn new_b777_rudder_aero_model() -> AerodynamicModel {
        let body = Self::b777_rudder_body(true);
        AerodynamicModel::new(
            &body,
            Some(Vector3::new(1., 0., 0.)),
            Some(Vector3::new(0., 0., 1.)),
...
struct B777GearDoorFactory {}
impl B777GearDoorFactory {
    fn b777_nose_gear_door_aerodynamics() -> AerodynamicModel {
    ...
    fn b777_left_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::b777_left_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
    ...
    fn b777_right_gear_door_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::b777_right_gear_door_body(),
            Some(Vector3::new(0., 1., 0.)),
            Some(Vector3::new(0., -0.1, 1.)),
            Some(Vector3::new(0., 1., 0.1)),
            Ratio::new::<ratio>(0.7),
    ...
    fn b777_nose_gear_door_actuator(
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
        const FLOW_CONTROL_PROPORTIONAL_GAIN: f64 = 0.15;
    ...
    fn b777_main_gear_door_actuator(
        bounded_linear_length: &impl BoundedLinearLength,
    ) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn b777_left_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn b777_right_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(1.73, 0.02, 1.7);
        let cg_offset = Vector3::new(2. / 3. * size[0], 0.1, 0.);
    ...
    fn b777_nose_gear_door_body() -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn b777_gear_door_assembly(wheel_id: GearWheel) -> HydraulicLinearActuatorAssembly<1> {
        let gear_door_body = match wheel_id {
            GearWheel::NOSE => Self::b777_nose_gear_door_body(),
            GearWheel::LEFT => Self::b777_left_gear_door_body(),
            GearWheel::RIGHT => Self::b777_right_gear_door_body(),
        };
        let gear_door_actuator = match wheel_id {
            GearWheel::NOSE => Self::b777_nose_gear_door_actuator(&gear_door_body),
            GearWheel::LEFT | GearWheel::RIGHT => {
                Self::b777_main_gear_door_actuator(&gear_door_body)
            }
        };
...
struct B777GearFactory {}
impl B777GearFactory {
    fn b777_nose_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::b777_nose_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            None,
            None,
    ...
    fn b777_right_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::b777_right_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
    ...
    fn b777_left_gear_aerodynamics() -> AerodynamicModel {
        AerodynamicModel::new(
            &Self::b777_left_gear_body(true),
            Some(Vector3::new(0., 0., 1.)),
            Some(Vector3::new(-0.3, 0., 1.)),
            Some(Vector3::new(-1., 0., -0.3)),
            Ratio::new::<ratio>(0.7),
    ...
    fn b777_nose_gear_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
        const FLOW_CONTROL_INTEGRAL_GAIN: f64 = 5.;
    ...
    fn b777_main_gear_actuator(bounded_linear_length: &impl BoundedLinearLength) -> LinearActuator {
    ...
    fn b777_left_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn b777_right_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
        let size = Vector3::new(0.3, 3.453, 0.3);
        let cg_offset = Vector3::new(0., -3. / 4. * size[1], 0.);
    ...
    fn b777_nose_gear_body(init_downlocked: bool) -> LinearActuatedRigidBodyOnHingeAxis {
    ...
    fn b777_gear_assembly(
        wheel_id: GearWheel,
        init_downlocked: bool,
    ) -> HydraulicLinearActuatorAssembly<1> {
        let gear_body = match wheel_id {
            GearWheel::NOSE => Self::b777_nose_gear_body(init_downlocked),

            GearWheel::LEFT => Self::b777_left_gear_body(init_downlocked),

            GearWheel::RIGHT => Self::b777_right_gear_body(init_downlocked),
        };

        let gear_actuator = match wheel_id {
            GearWheel::NOSE => Self::b777_nose_gear_actuator(&gear_body),

            GearWheel::LEFT | GearWheel::RIGHT => Self::b777_main_gear_actuator(&gear_body),
        };
...
struct B777GearSystemFactory {}
impl B777GearSystemFactory {
    fn b777_gear_system(context: &mut InitContext) -> HydraulicGearSystem {
        let init_downlocked = context.start_gear_down();

        HydraulicGearSystem::new(
            context,
            B777GearDoorFactory::b777_gear_door_assembly(GearWheel::NOSE),
            B777GearDoorFactory::b777_gear_door_assembly(GearWheel::LEFT),
            B777GearDoorFactory::b777_gear_door_assembly(GearWheel::RIGHT),
            B777GearFactory::b777_gear_assembly(GearWheel::NOSE, init_downlocked),
            B777GearFactory::b777_gear_assembly(GearWheel::LEFT, init_downlocked),
            B777GearFactory::b777_gear_assembly(GearWheel::RIGHT, init_downlocked),
            B777GearDoorFactory::b777_left_gear_door_aerodynamics(),
            B777GearDoorFactory::b777_right_gear_door_aerodynamics(),
            B777GearDoorFactory::b777_nose_gear_door_aerodynamics(),
            B777GearFactory::b777_left_gear_aerodynamics(),
            B777GearFactory::b777_right_gear_aerodynamics(),
            B777GearFactory::b777_nose_gear_aerodynamics(),
        )
    }
}
struct B777PowerTransferUnitCharacteristics {
    efficiency: Ratio,
...
impl B777PowerTransferUnitCharacteristics {
...
impl PowerTransferUnitCharacteristics for B777PowerTransferUnitCharacteristics {
...
pub(super) struct B777Hydraulic {
    ...
    brake_steer_computer: B777HydraulicBrakeSteerComputerUnit,

    blue_circuit: HydraulicCircuit,
    blue_circuit_controller: B777HydraulicCircuitController,
    green_circuit: HydraulicCircuit,
    green_circuit_controller: B777HydraulicCircuitController,
    yellow_circuit: HydraulicCircuit,
    yellow_circuit_controller: B777HydraulicCircuitController,

    engine_driven_pump_1: EngineDrivenPump,
    engine_driven_pump_1_controller: B777EngineDrivenPumpController,

    engine_driven_pump_2: EngineDrivenPump,
    engine_driven_pump_2_controller: B777EngineDrivenPumpController,

    blue_electric_pump: ElectricPump,
    blue_electric_pump_controller: B777BlueElectricPumpController,

    yellow_electric_pump: ElectricPump,
    yellow_electric_pump_controller: B777YellowElectricPumpController,

    pushback_tug: PushbackTug,

    ram_air_turbine: RamAirTurbine,
    ram_air_turbine_controller: B777RamAirTurbineController,

    power_transfer_unit: PowerTransferUnit,
    power_transfer_unit_controller: B777PowerTransferUnitController,

    braking_circuit_norm: BrakeCircuit,
    braking_circuit_altn: BrakeCircuit,
    braking_force: B777BrakingForce,
    ...
    forward_cargo_door_controller: B777DoorController,
    aft_cargo_door: CargoDoor,
    aft_cargo_door_controller: B777DoorController,
    ...
    gear_system_gravity_extension_controller: B777GravityExtension,
    gear_system_hydraulic_controller: B777GearHydraulicController,
    gear_system: HydraulicGearSystem,

    ptu_high_pitch_sound_active: DelayedFalseLogicGate,

    trim_controller: B777TrimInputController,
...
impl B777Hydraulic {
    ...
    pub(super) fn new(context: &mut InitContext) -> B777Hydraulic {
        B777Hydraulic {
            ...
            brake_steer_computer: B777HydraulicBrakeSteerComputerUnit::new(context),

            blue_circuit: B777HydraulicCircuitFactory::new_blue_circuit(context),
            blue_circuit_controller: B777HydraulicCircuitController::new(
                None,
                HydraulicColor::Blue,
            ),
            green_circuit: B777HydraulicCircuitFactory::new_green_circuit(context),
            green_circuit_controller: B777HydraulicCircuitController::new(
                Some(1),
                HydraulicColor::Green,
            ),
            yellow_circuit: B777HydraulicCircuitFactory::new_yellow_circuit(context),
            yellow_circuit_controller: B777HydraulicCircuitController::new(
                Some(2),
                HydraulicColor::Yellow,
            ),
            ...
            engine_driven_pump_1: EngineDrivenPump::new(
                context,
                "GREEN",
                PumpCharacteristics::b777_edp(),
            ),
            engine_driven_pump_1_controller: B777EngineDrivenPumpController::new(
                context,
                1,
            ...
            engine_driven_pump_2_controller: B777EngineDrivenPumpController::new(
                context,
                2,
                vec![
            ...
            blue_electric_pump: ElectricPump::new(
                ...
                PumpCharacteristics::b777_electric_pump(),
            ),
            blue_electric_pump_controller: B777BlueElectricPumpController::new(
                context,
            ...
            yellow_electric_pump_controller: B777YellowElectricPumpController::new(
                context,
            ...
            ram_air_turbine: RamAirTurbine::new(context, PumpCharacteristics::b777_rat()),
            ram_air_turbine_controller: B777RamAirTurbineController::new(
            ...
            power_transfer_unit: PowerTransferUnit::new(
                context,
                &B777PowerTransferUnitCharacteristics::new_randomized(),
            ),
            power_transfer_unit_controller: B777PowerTransferUnitController::new(
                context,
            ...
            braking_circuit_norm: BrakeCircuit::new(
                ...
                Pressure::new::<psi>(B777HydraulicCircuitFactory::HYDRAULIC_TARGET_PRESSURE_PSI),
            ),

            // Alternate brakes accumulator in real B777 is 1.5 gal capacity.
            ...
            braking_force: B777BrakingForce::new(context),
            ...
            forward_cargo_door: B777CargoDoorFactory::new_b777_cargo_door(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),
            forward_cargo_door_controller: B777DoorController::new(
                context,
                Self::FORWARD_CARGO_DOOR_ID,
            ),

            aft_cargo_door: B777CargoDoorFactory::new_b777_cargo_door(
                context,
                Self::AFT_CARGO_DOOR_ID,
            ),
            aft_cargo_door_controller: B777DoorController::new(context, Self::AFT_CARGO_DOOR_ID),
            ...
            left_aileron: B777AileronFactory::new_aileron(context, ActuatorSide::Left),
            right_aileron: B777AileronFactory::new_aileron(context, ActuatorSide::Right),
            left_elevator: B777ElevatorFactory::new_elevator(context, ActuatorSide::Left),
            right_elevator: B777ElevatorFactory::new_elevator(context, ActuatorSide::Right),

            fac_computer: RudderSystemHydraulicController::new(context),
            rudder: B777RudderFactory::new_rudder(context),

            left_spoilers: B777SpoilerFactory::new_b777_spoiler_group(context, ActuatorSide::Left),
            right_spoilers: B777SpoilerFactory::new_b777_spoiler_group(
                context,
                ActuatorSide::Right,
            ),

            gear_system_gravity_extension_controller: B777GravityExtension::new(context),
            gear_system_hydraulic_controller: B777GearHydraulicController::new(),
            gear_system: B777GearSystemFactory::b777_gear_system(context),

            ptu_high_pitch_sound_active: DelayedFalseLogicGate::new(
                Self::HIGH_PITCH_PTU_SOUND_DURATION,
            ),

            trim_controller: B777TrimInputController::new(context),
    ...
    pub(super) fn update(
        ...
        engine1: &impl Engine,
        engine2: &impl Engine,
        overhead_panel: &B777HydraulicOverheadPanel,
    ...
    fn update_core_hydraulics(
        ...
        self.engine_driven_pump_1.update(
            context,
            self.green_circuit
                .pump_section(B777HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES),
            self.green_circuit.reservoir(),
    ...
    fn should_show_hyd_ptu_message_on_ecam(&self) -> bool {
        ...
        let green_eng_pump_lo_pr = !self.green_circuit.pump_section_switch_pressurised(
            B777HydraulicCircuitFactory::YELLOW_GREEN_BLUE_PUMPS_INDEXES,
        );
...
impl SimulationElement for B777Hydraulic {
...
impl HydraulicGeneratorControlUnit for B777Hydraulic {
...
struct B777GearHydraulicController {
...
impl B777GearHydraulicController {
    fn new() -> Self {
        Self {
...
impl GearSystemController for B777GearHydraulicController {
...
struct B777HydraulicCircuitController {
...
impl B777HydraulicCircuitController {
    ...
    fn update(
        ...
        engine_fire_push_buttons: &impl EngineFirePushButtons,
        overhead_panel: &B777HydraulicOverheadPanel,
        yellow_epump_controller: &B777YellowElectricPumpController,
    ) {
...
impl HydraulicCircuitController for B777HydraulicCircuitController {
    fn should_open_fire_shutoff_valve(&self, _: usize) -> bool {
        // B777 only has one main pump per pump section thus index not useful
...
struct B777EngineDrivenPumpController {
...
impl B777EngineDrivenPumpController {
    fn new(
        context: &mut InitContext,
        engine_number: usize,
        powered_by: Vec<ElectricalBusType>,
...
impl PumpController for B777EngineDrivenPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for B777EngineDrivenPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        if self.engine_number == 1 {
            ...
            panic!("The B777 only supports two engines.");
        }
    }
...
struct B777BlueElectricPumpController {
...
impl B777BlueElectricPumpController {
...
impl PumpController for B777BlueElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for B777BlueElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
struct B777YellowElectricPumpController {
    low_press_id: VariableIdentifier,
...
impl B777YellowElectricPumpController {
...
impl PumpController for B777YellowElectricPumpController {
    fn should_pressurise(&self) -> bool {
        self.should_pressurise
    }
}
impl SimulationElement for B777YellowElectricPumpController {
    fn write(&self, writer: &mut SimulatorWriter) {
        writer.write(&self.low_press_id, self.is_pressure_low);
    }
...
struct B777PowerTransferUnitController {
...
impl B777PowerTransferUnitController {
...
impl PowerTransferUnitController for B777PowerTransferUnitController {
    fn should_enable(&self) -> bool {
        self.should_enable
    }
}
impl SimulationElement for B777PowerTransferUnitController {
...
struct B777RamAirTurbineController {
...
impl B777RamAirTurbineController {
...
impl RamAirTurbineController for B777RamAirTurbineController {
    fn should_deploy(&self) -> bool {
        self.should_deploy
    }
}
impl SimulationElement for B777RamAirTurbineController {
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
...
struct B777BrakeSystemOutputs {
    left_demand: Ratio,
    right_demand: Ratio,
    pressure_limit: Pressure,
}
impl B777BrakeSystemOutputs {
    fn new() -> Self {
        Self {
...
impl BrakeCircuitController for B777BrakeSystemOutputs {
...
struct B777HydraulicBrakeSteerComputerUnit {
    park_brake_lever_pos_id: VariableIdentifier,
    ...
    autobrake_controller: B777AutobrakeController,
    parking_brake_demand: bool,

    left_brake_pilot_input: Ratio,
    right_brake_pilot_input: Ratio,

    norm_brake_outputs: B777BrakeSystemOutputs,
    alternate_brake_outputs: B777BrakeSystemOutputs,
...
impl B777HydraulicBrakeSteerComputerUnit {
    ...
    fn new(context: &mut InitContext) -> Self {
        Self {
            ...
            autobrake_controller: B777AutobrakeController::new(context),

            parking_brake_demand: true,
            left_brake_pilot_input: Ratio::new::<ratio>(0.0),
            right_brake_pilot_input: Ratio::new::<ratio>(0.0),
            norm_brake_outputs: B777BrakeSystemOutputs::new(),
            alternate_brake_outputs: B777BrakeSystemOutputs::new(),
...
impl SimulationElement for B777HydraulicBrakeSteerComputerUnit {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
...
impl SteeringController for B777HydraulicBrakeSteerComputerUnit {
    fn requested_position(&self) -> Angle {
        self.final_steering_position_request
    }
}

struct B777BrakingForce {
...
impl SimulationElement for B777BrakingForce {
    fn write(&self, writer: &mut SimulatorWriter) {
...
impl HydraulicAssemblyController for B777DoorController {
...
impl SimulationElement for B777DoorController {
    fn read(&mut self, reader: &mut SimulatorReader) {
        self.position_requested = Ratio::new::<ratio>(reader.read(&self.requested_position_id));
    }
}
impl HydraulicLocking for B777DoorController {}
...
pub struct B777AutobrakeController {
...
impl B777AutobrakeController {
    ...
    fn new(context: &mut InitContext) -> B777AutobrakeController {
        B777AutobrakeController {
...
impl SimulationElement for B777AutobrakeController {
    fn write(&self, writer: &mut SimulatorWriter) {
...
pub(super) struct B777HydraulicOverheadPanel {
...
impl B777HydraulicOverheadPanel {
    pub(super) fn new(context: &mut InitContext) -> B777HydraulicOverheadPanel {
        B777HydraulicOverheadPanel {
    ...
    pub(super) fn update(&mut self, hyd: &B777Hydraulic) {
    ...
    fn edp_push_button_is_auto(&self, number: usize) -> bool {
        match number {
            ...
            _ => panic!("The B777 only supports two engines."),
        }
    }
...
impl SimulationElement for B777HydraulicOverheadPanel {
    fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
    ...
    fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        if !buses.is_powered(B777Hydraulic::BLUE_ELEC_PUMP_CONTROL_POWER_BUS)
            || !buses.is_powered(B777Hydraulic::BLUE_ELEC_PUMP_SUPPLY_POWER_BUS)
        {
            self.blue_epump_override_push_button.turn_off();
        }
    }
...
impl GearGravityExtension for B777GravityExtension {
    fn extension_handle_number_of_turns(&self) -> u8 {
        (self.handle_angle.get::<degree>() / 360.).floor() as u8
    }
}
impl SimulationElement for B777GravityExtension {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
struct B777TrimInputController {
...
impl PitchTrimActuatorController for B777TrimInputController {
...
impl ManualPitchTrimController for B777TrimInputController {
...
impl SimulationElement for B777TrimInputController {
    fn read(&mut self, reader: &mut SimulatorReader) {
...
mod tests {
    ...
    mod b777_hydraulics {
        ...
        struct B777TestEmergencyElectricalOverheadPanel {
            rat_and_emer_gen_man_on: MomentaryPushButton,
        }

        impl B777TestEmergencyElectricalOverheadPanel {
            pub fn new(context: &mut InitContext) -> Self {
                B777TestEmergencyElectricalOverheadPanel {
        ...
        impl SimulationElement for B777TestEmergencyElectricalOverheadPanel {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        impl EmergencyElectricalRatPushButton for B777TestEmergencyElectricalOverheadPanel {
        ...
        impl AdirsDiscreteOutputs for B777TestAdirus {
        ...
        struct B777TestPneumatics {
            pressure: Pressure,
        }
        impl B777TestPneumatics {
            pub fn new() -> Self {
                Self {
        ...
        impl ReservoirAirPressure for B777TestPneumatics {
        ...
        struct B777TestElectrical {
            airspeed: Velocity,
            all_ac_lost: bool,
            emergency_generator: TestGenerator,
        }
        impl B777TestElectrical {
            pub fn new() -> Self {
                B777TestElectrical {
        ...
        impl EmergencyElectricalState for B777TestElectrical {
            fn is_in_emergency_elec(&self) -> bool {
                self.all_ac_lost && self.airspeed >= Velocity::new::<knot>(100.)
            }
        }
        impl EmergencyGeneratorPower for B777TestElectrical {
            fn generated_power(&self) -> Power {
                self.emergency_generator.generated_power()
            }
        }
        impl SimulationElement for B777TestElectrical {
            fn receive_power(&mut self, buses: &impl ElectricalBuses) {
        ...
        struct B777HydraulicsTestAircraft {
            ...
            autobrake_panel: AutobrakePanel,
            emergency_electrical_overhead: B777TestEmergencyElectricalOverheadPanel,
            engine_fire_overhead: EngineFireOverheadPanel<2>,
            landing_gear: LandingGear,
            lgcius: LandingGearControlInterfaceUnitSet,
            adirus: B777TestAdirus,
            electrical: B777TestElectrical,
        ...
        impl B777HydraulicsTestAircraft {
            fn new(context: &mut InitContext) -> Self {
                Self {
                    ...
                    emergency_electrical_overhead: B777TestEmergencyElectricalOverheadPanel::new(
                        context,
                    ),
                    ...
                    adirus: B777TestAdirus::default(),
                    electrical: B777TestElectrical::new(),
            ...
            fn use_worst_case_ptu(&mut self) {
                self.hydraulics.power_transfer_unit.update_characteristics(
                    &B777PowerTransferUnitCharacteristics::new_worst_part_acceptable(),
                );
            }
        }

        impl Aircraft for B777HydraulicsTestAircraft {
        ...
        impl SimulationElement for B777HydraulicsTestAircraft {
            fn accept<T: SimulationElementVisitor>(&mut self, visitor: &mut T) {
        ...
        struct B777HydraulicsTestBed {
            test_bed: SimulationTestBed<B777HydraulicsTestAircraft>,
        }
        impl B777HydraulicsTestBed {
            fn new_with_start_state(start_state: StartState) -> Self {
                Self {
                    test_bed: SimulationTestBed::new_with_start_state(
                        start_state,
                        B777HydraulicsTestAircraft::new,
                    ),
                }
            }

            fn run_one_tick(mut self) -> Self {
                self.run_with_delta(B777Hydraulic::HYDRAULIC_SIM_TIME_STEP);
                self
            }
            ...
            fn autobrake_mode(&mut self) -> AutobrakeMode {
                ReadByName::<B777HydraulicsTestBed, f64>::read_by_name(
                    self,
            ...
            fn is_fire_valve_eng1_closed(&mut self) -> bool {
                !ReadByName::<B777HydraulicsTestBed, bool>::read_by_name(
                    self,
        ...
        impl TestBed for B777HydraulicsTestBed {
            type Aircraft = B777HydraulicsTestAircraft;

            fn test_bed(&self) -> &SimulationTestBed<B777HydraulicsTestAircraft> {
                &self.test_bed
            }

            fn test_bed_mut(&mut self) -> &mut SimulationTestBed<B777HydraulicsTestAircraft> {
                &mut self.test_bed
            }
        }

        fn test_bed_on_ground() -> B777HydraulicsTestBed {
            B777HydraulicsTestBed::new_with_start_state(StartState::Apron)
        }

        fn test_bed_in_flight() -> B777HydraulicsTestBed {
            B777HydraulicsTestBed::new_with_start_state(StartState::Cruise)
        }

        fn test_bed_on_ground_with() -> B777HydraulicsTestBed {
            test_bed_on_ground()
        }

        fn test_bed_in_flight_with() -> B777HydraulicsTestBed {
            test_bed_in_flight()
        }
        ...
        fn ptu_cargo_operation_inhibit() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                Duration::from_secs(1) + B777DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL,
            );

            assert!(!test_bed.is_ptu_enabled());
            test_bed = test_bed.run_waiting_for(
                Duration::from_secs(25) + B777PowerTransferUnitController::DURATION_OF_PTU_INHIBIT_AFTER_CARGO_DOOR_OPERATION,
        ...
        fn cargo_door_yellow_epump_powering() {
            ...
            test_bed = test_bed.run_waiting_for(
                B777YellowElectricPumpController::DURATION_OF_YELLOW_PUMP_ACTIVATION_AFTER_CARGO_DOOR_OPERATION,
            );
        ...
        fn cargo_door_controller_opens_the_door() {
            ...
            test_bed = test_bed.open_fwd_cargo_door().run_waiting_for(
                B777DoorController::DELAY_UNLOCK_TO_HYDRAULIC_CONTROL + Duration::from_secs(1),
            );
        ...
        fn leak_meas_valve_opens_after_yellow_pump_auto_shutdown_plus_a_delay_and_elevators_stay_drooped_down(
            ...
            test_bed = test_bed.run_waiting_for(
                B777HydraulicCircuitController::DELAY_TO_REOPEN_LEAK_VALVE_AFTER_CARGO_DOOR_USE,
            );
            assert!(test_bed.is_yellow_leak_meas_valve_commanded_open());
