(function (global, factory) {
  ...
  class B777_FMC_IdentPage {
    static ShowPage1(fmc) {
      ...
      // B777-200F IdentPage
      fmc._renderer.render([['MODEL', 'ENG RATING'], ['777-200.4', 'GE90-110B1L2'], ['NAV DATA', 'ACTIVE'], ['AIRAC', date.toString()], ['OP PROGRAM', 'CO DATA'], [fmc.fmcManVersion, 'VS1001'], ['OPC'], [fmc.fmcBakVersion, ''], ['', 'DRAG/FF'], ['', '+0.0/+0.0'], ['', '__FMCSEPARATOR', ''], ['<INDEX', 'POS INIT>']]);
      if (fmc.urlConfig.index == 1) {
        fmc._renderer.lsk(6).event = () => {
          B777_FMC_InitRefIndexPage.ShowPage1(fmc);
        };
