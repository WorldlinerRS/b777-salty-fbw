class SaltySpeedComputer {
    ...
    updateMaxSpeed() {
        ...
        SimVar.SetSimVarValue("L:77S_ADC_MAXIMUM_SPEED", "knots", maxSpeed);
    }
    updateMinSpeeds() {
        ...
        if (flapSetting === 0) {
            ...
            SimVar.SetSimVarValue("L:77S_ADC_MANEUVERING_SPEED", "knots", stallSpeed1G * Math.sqrt(1.3));
            SimVar.SetSimVarValue("L:77S_ADC_MINIMUM_SPEED", "knots", stallSpeed1G * Math.sqrt(gLoad));
        }
        else {
    ...
    computeMach() {
        ...
        SimVar.SetSimVarValue("L:77S_ADC_MACH_NUMBER", "number", mach);
    }
}