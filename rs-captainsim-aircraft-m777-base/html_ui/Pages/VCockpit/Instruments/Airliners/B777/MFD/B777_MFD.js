        ...
        switch (_event) {
            ...
            case "BARO_INC":
                if (SimVar.GetSimVarValue("L:XMLVAR_Baro1_ForcedToSTD", "bool") == true) {
                    SimVar.SetSimVarValue("L:77S_BARO_PRESEL_VISIBLE", "bool", true);
                    if (units == "millibar") {
            ...
            case "STD_PUSH":
                this.qnhIsPreSelected = false;
                SimVar.SetSimVarValue("L:77S_BARO_PRESEL_VISIBLE", "bool", false);
                break;
            case "Mins_INC":
                if (SimVar.GetSimVarValue("L:XMLVAR_Mins_Selector_Baro", "bool") == true) {
                    this.minimumReferenceBaro += 10;
                    SimVar.SetSimVarValue("L:77S_MINS_BARO", "feet", this.minimumReferenceBaro);
                }
                else {
                    this.minimumReferenceRadio += 10;
                    SimVar.SetSimVarValue("L:77S_MINS_RADIO", "feet", this.minimumReferenceRadio);
                }
                break;
            case "Mins_DEC":
                if (SimVar.GetSimVarValue("L:XMLVAR_Mins_Selector_Baro", "bool") == true) {
